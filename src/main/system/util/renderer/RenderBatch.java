...
import main.system.util.components.Shader;
...
public class RenderBatch implements Comparable<RenderBatch>, RegisterMapData {

    // Vertex
    //
    //============
    // Pos              Color                               tex coord       texid
    // float, float,   float, float, float, float             f  f             f
    ...
    public RenderBatch(int maxBatchSize, int zIndex) {
        ...
        shader = AssetPool.getShader(shaderAddress);
